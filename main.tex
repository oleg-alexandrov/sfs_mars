...
resolution CTX images and a high-resolution CTX DEM, that we use to to enhance a high-resolution CTX DEM, which we compare to an even higher resolution HiRISE DEM.
\end{abstract}
...
%\added{We would like to thank the anonymous reviewers for insightful and constructive reviews of this paper.} % this is repeated below
